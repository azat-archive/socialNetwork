...
Paginator.prototype.init = function() {
	if ($('div.paginationControl').length === 0) {
		return false;
	}
...
Paginator.prototype.goToPage = function(page) {
	...
	if (!this.haveAction()) {
		location += (location.substr(-1) != '/' ? '/' : '') + 'index';
	}
...
Paginator.prototype.bind = function() {
	if ($('div.paginationControl ul.prevNext li a.prev').length !== 0) {
	...
	if ($('div.paginationControl ul.prevNext li a.next').length !== 0) {
